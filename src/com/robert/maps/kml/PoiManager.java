...
public class PoiManager implements PoiConstants {
	...
	public PoiManager(Context ctx) {
		super();
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer Constructor is called");
		mCtx = ctx;
	...
	public void deletePoiByCategory(final int id){
		mGeoDatabase.deletePoiByCategory(id);
	}
	...
	public void updatePoiCategory(PoiCategory poiCategory) {
		if(poiCategory.getId() < ZERO)
	        ...
	        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer updatePoiCategory is about to call mGeoDatabase with these values: id: " + poiCategory.getId());
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer updatePoiCategory is about to call mGeoDatabase with these values: Title: " + poiCategory.Title);
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer updatePoiCategory is about to call mGeoDatabase with these values: Hidden: " + poiCategory.Hidden);
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer updatePoiCategory is about to call mGeoDatabase with these values: Iconid: " + poiCategory.IconId);
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer updatePoiCategory is about to call mGeoDatabase with these values: MinZoom: " + poiCategory.MinZoom);
	...
	public void loadPoiCategory(PoiCategory poiCategory) {
		if(poiCategory.getId() < ZERO)
			mGeoDatabase.addPoiCategory(poiCategory.Title, poiCategory.Hidden == true ? ONE : ZERO, poiCategory.IconId);
		else
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer about to call mGeoDatabase delete categories with these category values: id: " + poiCategory.getId());
		this.deletePoiCategory(poiCategory.getId());
	    
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer addPoiCategory is about to call mGeoDatabase with these values: id: " + poiCategory.getId());
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer adddPoiCategory is about to call mGeoDatabase with these values: Title: " + poiCategory.Title);
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer addPoiCategory is about to call mGeoDatabase with these values: Hidden: " + poiCategory.Hidden);
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer addPoiCategory is about to call mGeoDatabase with these values: Iconid: " + poiCategory.IconId);
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer addPoiCategory is about to call mGeoDatabase with these values: MinZoom: " + poiCategory.MinZoom);
			mGeoDatabase.loadPoiCategory(poiCategory.getId(), poiCategory.Title, poiCategory.Hidden == true ? ONE : ZERO, poiCategory.IconId, poiCategory.MinZoom);
	}
	...
	public void beginTransaction(){
        if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "PoiManagaer BeginTransaction is about to be called");
