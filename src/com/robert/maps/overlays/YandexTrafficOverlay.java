...
public class YandexTrafficOverlay extends OpenStreetMapViewOverlay implements OpenStreetMapConstants,
	...
	public YandexTrafficOverlay(Context ctx, OpenStreetMapView mapView) {
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "YandexTrafficOverlay Constructor is Called");
		mMapView = mapView;
	...
	protected void onDraw(Canvas c, OpenStreetMapView osmv) {
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "YandexTrafficOverlay onDraw is Called");
...
//				Log.i(DEBUGTAG, tileURLString);
				if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "YandexTrafficOverlay onDraw Loop is Called");
	...
	private class SimpleInvalidationHandler extends Handler {
		...
		public void handleMessage(final Message msg) {
			...
			case OpenStreetMapTileFilesystemProvider.MAPTILEFSLOADER_SUCCESS_ID:
				mMapView.invalidate();
				if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me-YandexTrafficOverlay", "YandexTrafficOverlay mMapView.invalidate() is Called");
	...
	private Point getUpperLeftCornerOfCenterMapTileInScreen(final int[] centerMapTileCoords, final int tileSizePx,
			final Point reuse) {
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "YandexTrafficOverlay getUpperLeftCornerOfCenterMapTileInScreen is Called");
