...
public class TrackWriterService extends Service implements OpenStreetMapConstants {
	...
	public void onCreate() {
		super.onCreate();
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "TrackWriterService onCreate is called");
		...
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "TrackWriterService onCreate is about to call showNotification");
		showNotification();
	...
	private void showNotification() {
		...
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "TrackWriterService showNotification is called and is about to call a new Intent of TrackListActivity");
		...
		public void onLocationChanged(final Location loc) {
			if (loc != null){
				...
				if(needWrite){
					...
					if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "TrackWriterService SampleLocationListener is called and is about to change the message to the class' own handler");
