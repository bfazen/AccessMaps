...
public abstract class OpenStreetMapViewOverlay implements OpenStreetMapConstants{
	...
	public void onManagedDraw(final Canvas c, final OpenStreetMapView osmv){
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "OSMViewOverlay onManaged Draw is called and is about to call OSMView onDraw ");
		onDraw(c, osmv);
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "OSMViewOverlay onManaged Draw is about to call OSMView onDrawFinished ");
