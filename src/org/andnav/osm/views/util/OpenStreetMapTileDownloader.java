...
public class OpenStreetMapTileDownloader implements OpenStreetMapConstants, OpenStreetMapViewConstants {
	...
	public void getRemoteImageAsync(final String aURLString, final Handler callback, final int aX, final int aY, final int aZ) {
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "OSMTileDownloader getRemoteImageAsync is called");
		this.mThreadPool.execute(new Runnable(){
			public void run() {
				...
				try {
					...
					if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "OSMTileDownloader handleMessage MAPTILEDOWNLOADER_SUCCESS_ID: " + MAPTILEDOWNLOADER_SUCCESS_ID);
					...
					if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "OSMTileDownloader handleMessage MAPTILEDOWNLOADER_FAIL_ID: " + MAPTILEDOWNLOADER_FAIL_ID);
