...
public class OpenStreetMapTileCache implements OpenStreetMapViewConstants{
	...
	public synchronized void putTile(final String aTileURLString, final Bitmap aTile) {
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "OSMTileCache putTile is Called");
	...
	public synchronized void Commit() {
		if(OpenStreetMapViewConstants.DEBUGMODE) Log.d("RMAPS-Me", "OSMTileCache Commit is Called");
